WITH CAR_AND_HISTORY AS (
    SELECT 
        ...
        h.END_DATE,
        CASE
            WHEN DATEDIFF(h.END_DATE, h.START_DATE) >= 90 THEN p.DISCOUNT_RATE
    ...
    LEFT JOIN CAR_RENTAL_COMPANY_DISCOUNT_PLAN p ON c.CAR_TYPE = p.CAR_TYPE AND p.DURATION_TYPE = '90일 이상'
    WHERE c.CAR_TYPE = '트럭'
)
